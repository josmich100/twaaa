...
import SideBar from '../../../Containers/Menubar/sidebar/SideBar';
...
export class CreatePost extends Component {
        ...
        switch (name) {
            ...
            case 'content':
                if (value.length > 0) {
                    errors.content =
                        value.length < 50
                            ? 'Content  must be 50 characters long!'
                            : '';
                }
    ...
    mySubmitHandler(e) {
        ...
        if (typeof (this.state.Post.imagePath) === "object") {
            ...
            // formData.append('content', stateToHTML(this.state.Post.content));
            ...
            formData = {
                ...
                'content': this.state.Post.Post.content,
    ...
    //     localStorage.setItem('myData', editorState.getCurrentContent())
    //   };
    render() {
        let isLoading
        let iserror
